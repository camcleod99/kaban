...
const MyComponent: React.FC<ColumnProps> = (props) => {
  return (
    ...
    >
      <h1 className="mx-2 mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">
        {props.columnName}
      </h1>
      <h2 className="mx-2 mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
